        ...
        <div class="row justify-content-center">
          <div class="col-lg-8">
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-5 p-2 mb-0">
                <div class="card-body">
                  ...
                  <form name="sentMessage"  method="post" action="<?php echo site_url('pelanggan/save');?>" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-4"><span class="input-group-text">
                            ...
                            <input class="form-control" name="namaPelanggan" type="text" placeholder="Nama Lengkap" aria-describedby="inputGroupPrepend2" required="">
                        </div>
                        <div class="input-group mb-4"><span class="input-group-text">
                            <svg class="icon">
                                <use xlink:href="<?php echo base_url('assets/admin2/dist/vendors/@coreui/icons/svg/free.svg#cil-lock-locked')?>"></use>
                            </svg></span>
                            <input class="form-control" name="email" type="email" placeholder="Email" aria-describedby="inputGroupPrepend2" required="">
                        </div>
                        ...
                        <div class="input-group mb-4"><span class="input-group-text">
                            ...
                            <input class="form-control" name="alamat" type="text" placeholder="Alamat" aria-describedby="inputGroupPrepend2" required="">
                        </div>
                         <div class="input-group mb-4"><span class="input-group-text">
                            <svg class="icon">
                                <use xlink:href="<?php echo base_url('assets/admin2/dist/vendors/@coreui/icons/svg/free.svg#cil-lock-locked')?>"></use>
                            </svg></span>
                            <input class="form-control" name="tlpn" type="text" placeholder="No Telepon" aria-describedby="inputGroupPrepend2" required="">
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <button class="btn px-4 text-white" style="background-color: #1283b8;" type="submit">Create</button>
                            </div>
                        </div>
                    </form>
                </div>
              ...
              <div class="card col-md-5 text-white py-5" style="background-color: #1283b8;">
                <div class="card-body text-center">
                  <div>
                    ...
                    <a href="<?php echo site_url('home/login');?>" class="btn btn-lg btn-outline-light mt-3" type="button">Login</a>
                  </div>
                </div>
              </div>
            </div>
